...
class JiraInfo:
    ...
    def __init__(self, user_login: str, jira_server_address: str, basic_auth: JiraBasicAuth):
...
class UserWorklogItemDto:
    ...
    def __init__(self, task_code: str, task_name: str, start_period_date: datetime, end_period_date: datetime, time_spent_seconds: int):
